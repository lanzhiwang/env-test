...
# normal(client) mode
mkdir ./envlog
docker run -it --rm --name env-test_client --net=my-network -e RUN_MODE=normal -e IPERF3_SERVER_ADDR=172.18.0.2 -e IPERF3_SERVER_PORT=3389 -v ./envlog:/workspace/log env-test:v0.7
...
client模式：
mkdir envlog
docker run -it --rm --name env-test_client --net=host -e SLEEP_TIME=3600 -e RUN_MODE=normal -v ./envlog:/workspace/log -e IPERF3_SERVER_ADDR=10.0.128.156 -e IPERF3_SERVER_PORT=3389 registry.alauda.cn:60080/middleware/env-test:20220929154924
```
